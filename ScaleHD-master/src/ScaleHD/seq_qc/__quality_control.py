...
import warnings; warnings.simplefilter("ignore") ## lazy
...
class SeqQC:
	...
	def execute_trimming(self):
		...
		def execute_cutadapt(arguments_split, filename_root, sample_output):
			...
			cutadapt_report = cutadapt_raw_output[0].decode()
			cutadapt_errors = cutadapt_raw_output[1].decode()
...
class BatchadaptWrapper:
	...
	def get_targets(self):
		...
		self.target_dir = str(self.data_dir) + '_demultiplexed'
